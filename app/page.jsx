...
const experience = [
  {
    ...
    responsibilities: [
      ...
      "Achieved remarkable accuracy improvements: Chandra OCR delivered 77.8% accuracy for structured documents, while PaddleOCR excelled at complex Hindi text extraction",
    ],
    stack: ["Python", "OpenCV", "Tesseract", "PyTorch", "Streamlit", "SQLite", "Deep Translator"],
    achievements: [
      "Built production-ready system handling 7 OCR engines (5 CPU-based, 2 GPU-optimized)",
      "Achieved 85.9% accuracy in automatic language detection across 15+ Indian languages",
      "Full Unicode support for Devanagari and other Indic scripts with zero encoding errors",
      "Complete ETL pipeline: Upload → Crop → Preprocess → Extract → Correct → Translate → Store",
    ],
  },
];
